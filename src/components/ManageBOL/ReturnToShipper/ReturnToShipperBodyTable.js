...
import {InsertProductReturnToShipperModal} from "./InsertProductReturnToShipperModal";

export class ReturnToShipperBodyTable extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    createCustomModal = (onModalClose, onSave, columns) => {
        ...
        return (
            <InsertProductReturnToShipperModal  {...attr} />
        );
    };
