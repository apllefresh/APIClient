...
export class InsertProductReturnToShipperModal extends React.Component {
        ...
        return (
            <div className='modal-content react-bs-table-insert-modal'>
                <div className='modal-header react-bs-table-inser-modal-header'>
                    <h4 className='modal-title'>Добавление товара в акт возврата</h4>
                ...
                <div className='modal-body'>
                    ...
                    <div className='form-group' key={columns[6].field}>
                        ...
                        <input className="form-control editor edit-text" ref={columns[6].field} type='text' defaultValue={''} />
